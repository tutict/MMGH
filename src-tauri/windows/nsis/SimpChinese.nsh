...
LangString failedToKillApp ${LANG_SIMPCHINESE} "无法结束 {{product_name}}。请先手动关闭后再重试。"
LangString installingWebview2 ${LANG_SIMPCHINESE} "正在安装 WebView2..."
LangString newerVersionInstalled ${LANG_SIMPCHINESE} "系统中已安装更新版本的 ${PRODUCTNAME}。不建议安装更旧的版本。如果你确实要安装旧版本，建议先卸载当前版本。请选择要执行的操作，然后点击“下一步”继续。"
...
LangString silentDowngrades ${LANG_SIMPCHINESE} "当前安装器已禁用降级，无法继续执行静默安装。请改用图形界面安装器。$\n"
...
LangString webview2AbortError ${LANG_SIMPCHINESE} "WebView2 安装失败！应用无法在缺少它的情况下运行。请尝试重新启动安装器。"
LangString webview2DownloadError ${LANG_SIMPCHINESE} "错误：下载 WebView2 失败 - $0"
LangString webview2DownloadSuccess ${LANG_SIMPCHINESE} "已成功下载 WebView2 引导程序"
