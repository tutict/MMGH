...
import { BUILT_IN_TRACKS, localizeTracks, type MusicTrack } from "./music/tracks";
import { resolveSkillDisplayTitle } from "./skills/starterSkillTitles";
...
function App() {
  ...
  const localizedTracks = useMemo(() => localizeTracks(tracks, t), [t, tracks]);
